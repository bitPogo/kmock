...
internal class PropertyProxy<Value>(
    ...
    private fun useSpyOrDefault(): PropertyProxyInvocationType {
        return if (spyOnGet == null) {
            PropertyProxyInvocationType.NO_PROVIDER
        } else {
            PropertyProxyInvocationType.SPY
        }
    }
    ...
    override fun onGet(): Value {
        ...
        return when (state.invocationType) {
            ...
            PropertyProxyInvocationType.SPY -> spyOnGet!!.invoke()
