...
class SyncFunProxyUnfrozenInvocationsSpec {
    ...
    @Test
    @JsName("fn2")
    fun `Given invoke is called it calls the given SideEffectChain with 0 Arguments and delegates values`() {
        // Given
        val proxy = SyncFunProxy<Any, () -> Any>(fixture.fixture(), freeze = false)
        val expected: Any = fixture.fixture()
    ...
    @Test
    @JsName("fn3")
    fun `Given invoke is called it calls the given Spy with 0 Arguments and delegates values`() {
        // Given
        val expected: Any = fixture.fixture()
    ...
    @Test
    @JsName("fn5")
    fun `Given invoke is called it calls the given SideEffectChain with 1 Argument and delegates values`() {
        // Given
        val proxy = SyncFunProxy<Any, (String) -> Any>(
            fixture.fixture(),
            freeze = false
    ...
    @Test
    @JsName("fn6")
    fun `Given invoke is called it calls the given Spy with 1 Argument and delegates values`() {
        // Given
        val argument0: String = fixture.fixture()
        val expected: Any = fixture.fixture()
        val implementation = Implementation<Any>()
    ...
    @Test
    @JsName("fn8")
    fun `Given invoke is called it calls the given SideEffectChain with 2 Arguments and delegates values`() {
        // Given
        val proxy = SyncFunProxy<Any, (String, Int) -> Any>(
            fixture.fixture(),
            freeze = false
    ...
    @Test
    @JsName("fn9")
    fun `Given invoke is called it calls the given Spy with 2 Arguments and delegates values`() {
        // Given
        val implementation = Implementation<Any>()
        val argument0: String = fixture.fixture()
        val argument1: Int = fixture.fixture()
    ...
    @Test
    @JsName("fn11")
    fun `Given invoke is called it calls the given SideEffectChain with 3 Arguments and delegates values`() {
        // Given
        val proxy = SyncFunProxy<Any, (String, Int, String) -> Any>(
            fixture.fixture(),
            freeze = false
    ...
    @Test
    @JsName("fn12")
    fun `Given invoke is called it calls the given Spy with 3 Arguments and delegates values`() {
        // Given
        val implementation = Implementation<Any>()
        val argument0: String = fixture.fixture()
        val argument1: Int = fixture.fixture()
    ...
    @Test
    @JsName("fn14")
    fun `Given invoke is called it calls the given SideEffectChain with 4 Arguments and delegates values`() {
        // Given
        val proxy = SyncFunProxy<Any, (String, Int, String, Int) -> Any>(
            fixture.fixture(),
            freeze = false
    ...
    @Test
    @JsName("fn15")
    fun `Given invoke is called it calls the given Spy with 4 Arguments and delegates values`() {
        // Given
        val implementation = Implementation<Any>()
    ...
    @Test
    @JsName("fn17")
    fun `Given invoke is called it calls the given SideEffectChain with 5 Arguments and delegates values`() {
        // Given
        val proxy = SyncFunProxy<Any, (String, Int, String, Int, String) -> Any>(
            fixture.fixture(),
            freeze = false
    ...
    @Test
    @JsName("fn18")
    fun `Given invoke is called it calls the given Spy with 5 Arguments and delegates values`() {
        // Given
        val implementation = Implementation<Any>()
    ...
    @Test
    @JsName("fn20")
    fun `Given invoke is called it calls the given SideEffectChain with 6 Arguments and delegates values`() {
        // Given
        val proxy = SyncFunProxy<Any, (String, Int, String, Int, String, Int) -> Any>(
            fixture.fixture(),
            freeze = false
    ...
    @Test
    @JsName("fn21")
    fun `Given invoke is called it calls the given Spy with 6 Arguments and delegates values`() {
        // Given
        val implementation = Implementation<Any>()
    ...
    @Test
    @JsName("fn23")
    fun `Given invoke is called it calls the given SideEffectChain with 7 Arguments and delegates values`() {
        // Given
        val proxy = SyncFunProxy<Any, (String, Int, String, Int, String, Int, String) -> Any>(
            fixture.fixture(),
            freeze = false
    ...
    @Test
    @JsName("fn24")
    fun `Given invoke is called it calls the given Spy with 7 Arguments and delegates values`() {
        // Given
        val implementation = Implementation<Any>()
    ...
    @Test
    @JsName("fn26")
    fun `Given invoke is called it calls the given SideEffectChain with 8 Arguments and delegates values`() {
        // Given
        val proxy = SyncFunProxy<Any, (String, Int, String, Int, String, Int, String, Int) -> Any>(
            fixture.fixture(),
            freeze = false
    ...
    @Test
    @JsName("fn27")
    fun `Given invoke is called it calls the given Spy with 8 Arguments and delegates values`() {
        // Given
        val implementation = Implementation<Any>()
    ...
    @Test
    @JsName("fn29")
    fun `Given invoke is called it calls the given SideEffectChain with 9 Arguments and delegates values`() {
        // Given
        val proxy = SyncFunProxy<Any, (String, Int, String, Int, String, Int, String, Int, String) -> Any>(
            fixture.fixture(),
            freeze = false
    ...
    @Test
    @JsName("fn30")
    fun `Given invoke is called it calls the given Spy with 9 Arguments and delegates values`() {
        // Given
        val implementation = Implementation<Any>()
    ...
    @Test
    @JsName("fn32")
    fun `Given invoke is called it calls the given SideEffectChain with 10 Arguments and delegates values`() {
        // Given
        val proxy = SyncFunProxy<Any, (String, Int, String, Int, String, Int, String, Int, String, Int) -> Any>(
            fixture.fixture(),
            freeze = false
    ...
    @Test
    @JsName("fn33")
    fun `Given invoke is called it calls the given Spy with 10 Arguments and delegates values`() {
        // Given
        val implementation = Implementation<Any>()
    ...
    @Test
    @JsName("fn35")
    fun `Given invoke is called it calls the given SideEffectChain with 11 Arguments and delegates values`() {
        // Given
        val proxy = SyncFunProxy<Any, (String, Int, String, Int, String, Int, String, Int, String, Int, String) -> Any>(
            fixture.fixture(),
            freeze = false
    ...
    @Test
    @JsName("fn36")
    fun `Given invoke is called it calls the given Spy with 11 Arguments and delegates values`() {
        // Given
        val implementation = Implementation<Any>()
    ...
    @Test
    @JsName("fn38")
    fun `Given invoke is called it calls the given SideEffectChain with 12 Arguments and delegates values`() {
        // Given
        val proxy = SyncFunProxy<Any, (String, Int, String, Int, String, Int, String, Int, String, Int, String, Int) -> Any>(
            fixture.fixture(),
            freeze = false
    ...
    @Test
    @JsName("fn39")
    fun `Given invoke is called it calls the given Spy with 12 Arguments and delegates values`() {
        // Given
        val implementation = Implementation<Any>()
    ...
    @Test
    @JsName("fn41")
    fun `Given invoke is called it calls the given SideEffectChain with 13 Arguments and delegates values`() {
        // Given
        val proxy = SyncFunProxy<Any, (String, Int, String, Int, String, Int, String, Int, String, Int, String, Int, String) -> Any>(
            fixture.fixture(),
            freeze = false
    ...
    @Test
    @JsName("fn42")
    fun `Given invoke is called it calls the given Spy with 13 Arguments and delegates values`() {
        // Given
        val implementation = Implementation<Any>()
