...
class KMockAggregatorSharedSpec {
    ...
    @Test
    fun `Given extractSharedInterfaces is called it resolves the Annotated Thing as ill, if no KMockAnnotation was found`() {
        // Given
    ...
    @Test
    fun `Given extractSharedInterfaces is called it filters all ill Stub Annotations`() {
        // Given
        val source: KSAnnotated = mockk()
        val resolver: Resolver = mockk()
