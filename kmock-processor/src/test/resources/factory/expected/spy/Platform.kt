...
internal inline fun <reified Mock> kmock(
    ...
    factory.template.spy.Platform2::class -> factory.template.spy.Platform2Mock(verifier = verifier,
    ...
    factory.template.spy.Platform3::class -> factory.template.spy.Platform3Mock(verifier = verifier,
        relaxUnitFun = relaxUnitFun, freeze = freeze) as Mock
...
internal inline fun <reified Mock : SpyOn, reified SpyOn> kspy(
    ...
    factory.template.spy.Platform2::class -> factory.template.spy.Platform2Mock(verifier = verifier,
        freeze = freeze, spyOn = spyOn as factory.template.spy.Platform2) as Mock
    factory.template.spy.Platform2Mock::class -> factory.template.spy.Platform2Mock(verifier =
...
internal inline fun <reified Mock : Platform1<K, L>, K : Any, L> kmock(
    ...
    factory.template.spy.Platform1::class -> factory.template.spy.Platform1Mock<K, L>(verifier =
    verifier, relaxUnitFun = relaxUnitFun, freeze = freeze) as Mock
...
internal inline fun <reified Mock : SpyOn, reified SpyOn : Platform1<K, L>, K : Any, L> kspy(
    ...
    factory.template.spy.Platform1::class -> factory.template.spy.Platform1Mock(verifier = verifier,
        freeze = freeze, spyOn = spyOn as factory.template.spy.Platform1<K, L>) as Mock
