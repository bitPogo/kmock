...
import factory.template.spy.Shared3
import kotlin.Any
...
internal actual inline fun <reified Mock : Shared1<K, L>, K : Any, L> kmock(
    ...
    factory.template.spy.Shared1::class -> factory.template.spy.Shared1Mock<K, L>(verifier = verifier,
...
internal actual inline fun <reified Mock : Shared2<K, L>, K : Any, L> kmock(
    ...
    factory.template.spy.Shared2::class -> factory.template.spy.Shared2Mock<K, L>(verifier = verifier,
        relaxUnitFun = relaxUnitFun, freeze = freeze) as Mock
    factory.template.spy.Shared2Mock::class -> factory.template.spy.Shared2Mock<K, L>(verifier =
    verifier, relaxUnitFun = relaxUnitFun, freeze = freeze) as Mock
    else -> throw RuntimeException("Unknown Interface ${Mock::class.simpleName}.")
}
...
internal actual inline fun <reified Mock : Shared3<K, L>, K : Any, L> kmock(
    ...
    @Suppress("UNUSED_PARAMETER") relaxUnitFun: Boolean,
    freeze: Boolean,
    @Suppress("UNUSED_PARAMETER") templateType: kotlin.reflect.KClass<factory.template.spy.Shared3<*,
        *>>
): Mock where L : Any, L : Comparable<L> = when (Mock::class) {
    factory.template.spy.Shared3::class -> factory.template.spy.Shared3Mock<K, L>(verifier = verifier,
        relaxUnitFun = relaxUnitFun, freeze = freeze) as Mock
    factory.template.spy.Shared3Mock::class -> factory.template.spy.Shared3Mock<K, L>(verifier =
    verifier, relaxUnitFun = relaxUnitFun, freeze = freeze) as Mock
    else -> throw RuntimeException("Unknown Interface ${Mock::class.simpleName}.")
}
