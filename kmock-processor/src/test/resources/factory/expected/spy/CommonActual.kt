...
internal actual inline fun <reified Mock> kmock(
    ...
    factory.template.spy.Common2::class -> factory.template.spy.Common2Mock(verifier = verifier,
...
internal actual inline fun <reified Mock : Common1<K, L>, K : Any, L> kmock(
    ...
    factory.template.spy.Common1::class -> factory.template.spy.Common1Mock<K, L>(verifier = verifier,
        relaxUnitFun = relaxUnitFun, freeze = freeze) as Mock
...
internal actual inline fun <reified Mock : SpyOn, reified SpyOn : Common1<K, L>, K : Any, L> kspy(
    ...
    factory.template.spy.Common1::class -> factory.template.spy.Common1Mock(verifier = verifier,
