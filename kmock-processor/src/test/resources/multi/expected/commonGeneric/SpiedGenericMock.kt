...
GenericCommonContract.Generic3<KMockTypeParameter4, KMockTypeParameter5> {
    ...
    public val _ossWithZTAny: KMockContract.SyncFunProxy<Any?, (Any?) -> Any?> =
        ProxyFactory.createSyncFunProxy("multi.CommonGenericMultiMock#_ossWithZTAny", collector =
        collector, freeze = freeze)

    public val _ossWithZTAnyZRAny: KMockContract.SyncFunProxy<Unit, (Any?, Any?) -> Unit> =
        ProxyFactory.createSyncFunProxy("multi.CommonGenericMultiMock#_ossWithZTAnyZRAny", collector =
        collector, freeze = freeze)

    public val _ossWithZRAnyZTAnys: KMockContract.SyncFunProxy<Unit, (Any?, Array<*>) -> Unit> =
        ProxyFactory.createSyncFunProxy("multi.CommonGenericMultiMock#_ossWithZRAnyZTAnys", collector
        = collector, freeze = freeze)
    ...
    public val _xssWithZTAnyRSequenceRCharSequence: KMockContract.SyncFunProxy<Unit, (Any?,
        Any) -> Unit> =
        ProxyFactory.createSyncFunProxy("multi.CommonGenericMultiMock#_xssWithZTAnyRSequenceRCharSequence",
            collector = collector, freeze = freeze)
    ...
    public val _equals: KMockContract.SyncFunProxy<Boolean, (Any?) -> Boolean> =
        ProxyFactory.createSyncFunProxy("multi.CommonGenericMultiMock#_equals", collector = collector,
