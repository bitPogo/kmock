...
internal class SyncFunctionCommonMock(
    ...
    private val __spyOn: SyncFunctionCommon? = spyOn
    ...
    public val _toString: KMockContract.SyncFunProxy<String, () -> kotlin.String> =
        SyncFunProxy("generatorTest.SyncFunctionCommon#_toString", spyOn = if (spyOn != null) { {
    ...
    public val _equals: KMockContract.SyncFunProxy<Boolean, (kotlin.Any?) -> kotlin.Boolean> =
        SyncFunProxy("generatorTest.SyncFunctionCommon#_equals", spyOn = if (spyOn != null) { {
                other ->
    ...
    public val _hashCode: KMockContract.SyncFunProxy<Int, () -> kotlin.Int> =
        SyncFunProxy("generatorTest.SyncFunctionCommon#_hashCode", spyOn = if (spyOn != null) { {
    ...
    public override fun equals(other: Any?): Boolean {
        return if(other is SyncFunctionCommonMock && __spyOn != null) {
            super.equals(other)
        } else {
