...
internal class PropertySharedMock(
    ...
    public val _foo: KMockContract.PropertyProxy<String> = if (spyOn == null) {
        PropertyProxy("generatorTest.PropertyShared#_foo", spyOnGet = null, collector = verifier,
            freeze = freeze, relaxer = null)
    } else {
        PropertyProxy("generatorTest.PropertyShared#_foo", spyOnGet = { spyOn.foo }, collector =
    ...
    public val _buzz: KMockContract.PropertyProxy<Any> = if (spyOn == null) {
        PropertyProxy("generatorTest.PropertyShared#_buzz", spyOnGet = null, spyOnSet = null,
            collector = verifier, freeze = freeze, relaxer = null)
    } else {
        PropertyProxy("generatorTest.PropertyShared#_buzz", spyOnGet = { spyOn.buzz }, spyOnSet = {
            spyOn.buzz = it; Unit }, collector = verifier, freeze = freeze, relaxer = null)
    }


    public val _toString: KMockContract.SyncFunProxy<String, () -> kotlin.String> =
        SyncFunProxy("generatorTest.PropertyShared#_toString", spyOn = if (spyOn != null) { {
    ...
    public val _equals: KMockContract.SyncFunProxy<Boolean, (kotlin.Any?) -> kotlin.Boolean> =
        SyncFunProxy("generatorTest.PropertyShared#_equals", spyOn = if (spyOn != null) { { other ->
    ...
    public val _hashCode: KMockContract.SyncFunProxy<Int, () -> kotlin.Int> =
        SyncFunProxy("generatorTest.PropertyShared#_hashCode", spyOn = if (spyOn != null) { {
