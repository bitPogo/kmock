...
internal class AsyncFunctionSharedMock(
    ...
    public val _bar: KMockContract.SyncFunProxy<Any, (kotlin.Int, kotlin.Any) -> kotlin.Any> =
        SyncFunProxy("generatorTest.AsyncFunctionShared#_bar", spyOn = if (spyOn != null) { { buzz,
            bozz ->
            bar(buzz, bozz) } } else { null }, collector = verifier, freeze = freeze, relaxer = null)

    public val _toString: KMockContract.SyncFunProxy<String, () -> kotlin.String> =
        SyncFunProxy("generatorTest.AsyncFunctionShared#_toString", spyOn = if (spyOn != null) { {
    ...
    public val _equals: KMockContract.SyncFunProxy<Boolean, (kotlin.Any?) -> kotlin.Boolean> =
        SyncFunProxy("generatorTest.AsyncFunctionShared#_equals", spyOn = if (spyOn != null) { {
                other ->
    ...
    public val _hashCode: KMockContract.SyncFunProxy<Int, () -> kotlin.Int> =
        SyncFunProxy("generatorTest.AsyncFunctionShared#_hashCode", spyOn = if (spyOn != null) { {
