...
internal class AliasCommonMock(
    ...
    public val _toString: KMockContract.SyncFunProxy<String, () -> kotlin.String> =
        SyncFunProxy("mock.template.alias.Common#_toString", spyOn = if (spyOn != null) { {
    ...
    public val _equals: KMockContract.SyncFunProxy<Boolean, (kotlin.Any?) -> kotlin.Boolean> =
        SyncFunProxy("mock.template.alias.Common#_equals", spyOn = if (spyOn != null) { { other ->
    ...
    public val _hashCode: KMockContract.SyncFunProxy<Int, () -> kotlin.Int> =
        SyncFunProxy("mock.template.alias.Common#_hashCode", spyOn = if (spyOn != null) { {
    ...
    public override fun equals(other: Any?): Boolean {
        return if(other is AliasCommonMock && __spyOn != null) {
            super.equals(other)
        } else {
