...
internal class CommonMock(
    ...
    public val _uzz: KMockContract.PropertyProxy<Int> =
        PropertyProxy("mock.template.spy.CommonMock#_uzz", collector = verifier, freeze = freeze,
            relaxer = null)
    ...
    public val _fzz: KMockContract.PropertyProxy<Int> =
        PropertyProxy("mock.template.spy.CommonMock#_fzz", collector = verifier, freeze = freeze,
            relaxer = null)

    public val _foo: KMockContract.SyncFunProxy<Any, (kotlin.Int, kotlin.Any) -> kotlin.Any> =
        SyncFunProxy("mock.template.spy.CommonMock#_foo", spyOn = null, collector = verifier, freeze =
        freeze, relaxer = null)

    public val _bar: KMockContract.SyncFunProxy<Any, (kotlin.Int, kotlin.Any) -> kotlin.Any> =
        SyncFunProxy("mock.template.spy.CommonMock#_bar", spyOn = null, collector = verifier, freeze =
        freeze, relaxer = null)
