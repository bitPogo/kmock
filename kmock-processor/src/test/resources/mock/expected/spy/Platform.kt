...
internal class PlatformMock<K : Any, L>(
    ...
    public val _template: KMockContract.PropertyProxy<L> = if (spyOn == null) {
        PropertyProxy("mock.template.spy.PlatformMock#_template", spyOnGet = null, spyOnSet = null,
            collector = verifier, freeze = freeze, relaxer = null)} else {
        PropertyProxy("mock.template.spy.PlatformMock#_template", spyOnGet = { __spyOn!!.template },
    ...
    public val _ozz: KMockContract.PropertyProxy<Int> = if (spyOn == null) {
        PropertyProxy("mock.template.spy.PlatformMock#_ozz", spyOnGet = null, collector = verifier,
            freeze = freeze, relaxer = null)} else {
        PropertyProxy("mock.template.spy.PlatformMock#_ozz", spyOnGet = { __spyOn!!.ozz }, collector
        = verifier, freeze = freeze, relaxer = null)}


    public val _foo: KMockContract.SyncFunProxy<Unit, (kotlin.Any?) -> kotlin.Unit> =
        SyncFunProxy("mock.template.spy.PlatformMock#_foo", spyOn = if (spyOn != null) { { payload ->
    ...
    public val _bar: KMockContract.SyncFunProxy<Any, (kotlin.Int) -> kotlin.Any> =
        SyncFunProxy("mock.template.spy.PlatformMock#_bar", spyOn = if (spyOn != null) { { arg0 ->
    ...
    public val _buzz: KMockContract.AsyncFunProxy<L, suspend (kotlin.String) -> L> =
        AsyncFunProxy("mock.template.spy.PlatformMock#_buzz", spyOn = if (spyOn != null) { { arg0 ->
    ...
    public val _toString: KMockContract.SyncFunProxy<String, () -> kotlin.String> =
        SyncFunProxy("mock.template.spy.PlatformMock#_toString", spyOn = if (spyOn != null) { {
    ...
    public val _equals: KMockContract.SyncFunProxy<Boolean, (kotlin.Any?) -> kotlin.Boolean> =
        SyncFunProxy("mock.template.spy.PlatformMock#_equals", spyOn = if (spyOn != null) { { other ->
    ...
    public val _hashCode: KMockContract.SyncFunProxy<Int, () -> kotlin.Int> =
        SyncFunProxy("mock.template.spy.PlatformMock#_hashCode", spyOn = if (spyOn != null) { {
