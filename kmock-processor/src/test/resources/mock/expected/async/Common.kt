...
internal class CommonMock(
    ...
    public val _foo: KMockContract.AsyncFunProxy<Any, suspend (Int, Any) -> Any> =
        ProxyFactory.createAsyncFunProxy("mock.template.async.CommonMock#_foo", collector = collector,
            freeze = freeze)

    public val _bar: KMockContract.AsyncFunProxy<Any, suspend (Int, Any) -> Any> =
        ProxyFactory.createAsyncFunProxy("mock.template.async.CommonMock#_bar", collector = collector,
            freeze = freeze)

    public val _ozz: KMockContract.AsyncFunProxy<Any, suspend (IntArray) -> Any> =
        ProxyFactory.createAsyncFunProxy("mock.template.async.CommonMock#_ozz", collector = collector,
            freeze = freeze)

    public val _izz: KMockContract.AsyncFunProxy<Any, suspend (Array<out Any>) -> Any> =
        ProxyFactory.createAsyncFunProxy("mock.template.async.CommonMock#_izz", collector = collector,
            freeze = freeze)
