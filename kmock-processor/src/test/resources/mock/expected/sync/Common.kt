...
internal class CommonMock(
    ...
    public val _foo: KMockContract.SyncFunProxy<Any, (kotlin.Int, kotlin.Any) -> kotlin.Any> =
        SyncFunProxy("mock.template.sync.CommonMock#_foo", spyOn = null, collector = verifier, freeze
        = freeze, relaxer = null)

    public val _bar: KMockContract.SyncFunProxy<Any, (kotlin.Int, kotlin.Any) -> kotlin.Any> =
        SyncFunProxy("mock.template.sync.CommonMock#_bar", spyOn = null, collector = verifier, freeze
        = freeze, relaxer = null)
