...
internal class SharedMock<K : Any, L>(
    ...
    LazyThreadSafetyMode.PUBLICATION) {
        if (spyOn == null) {
            PropertyProxy("mock.template.generic.SharedMock#_template", spyOnGet = null, spyOnSet =
            null, collector = verifier, freeze = freeze, relaxer = null)
        } else {
            PropertyProxy("mock.template.generic.SharedMock#_template", spyOnGet = { spyOn.template
            }, spyOnSet = { spyOn.template = it; Unit }, collector = verifier, freeze = freeze,
                relaxer = null)
        }
    }

    public val _fooWithVoid: KMockContract.SyncFunProxy<Any?, () -> kotlin.Any?> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_fooWithVoid", spyOn = if (spyOn != null) {
            { foo() } } else { null }, collector = verifier, freeze = freeze, relaxer = null)
    }
    ...
    lazy(mode = LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_fooWithAny", spyOn = if (spyOn != null) { {
                payload ->
    ...
    public val _blaWithVoid: KMockContract.SyncFunProxy<Int, () -> kotlin.Int> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_blaWithVoid", spyOn = if (spyOn != null) {
            { bla() } } else { null }, collector = verifier, freeze = freeze, relaxer = null)
    }

    public val _blaWithInt: KMockContract.SyncFunProxy<Unit, (kotlin.Int) -> kotlin.Unit> by lazy(mode
    = LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_blaWithInt", spyOn = if (spyOn != null) { {
                payload ->
    ...
    public val _barWithCollectionsList:
        ...
        SyncFunProxy("mock.template.generic.SharedMock#_barWithCollectionsList", spyOn = if (spyOn
            != null) { { payload ->
    ...
    public val _barWithVoid:
        ...
        kotlin.collections.List<kotlin.Array<kotlin.String>>> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_barWithVoid", spyOn = if (spyOn != null) {
            { bar() } } else { null }, collector = verifier, freeze = freeze, relaxer = null)
    }

    public val _blubbWithCollectionsList:
        KMockContract.SyncFunProxy<Unit, (kotlin.collections.List<kotlin.Array<kotlin.String?>>) ->
        kotlin.Unit> by lazy(mode = LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_blubbWithCollectionsList", spyOn = if
                                                                                               (spyOn != null) { { payload ->
    ...
    public val _blubbWithVoid:
        ...
        kotlin.collections.List<kotlin.Array<kotlin.String?>>> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_blubbWithVoid", spyOn = if (spyOn != null)
    ...
    public val _bussWithCollectionsList:
        ...
        kotlin.Unit> by lazy(mode = LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_bussWithCollectionsList", spyOn = if (spyOn
            != null) { { payload ->
    ...
    public val _bussWithVoid:
        ...
        kotlin.collections.List<kotlin.Array<kotlin.Int>>?> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_bussWithVoid", spyOn = if (spyOn != null) {
    ...
    public val _bossWithCollectionsList:
        KMockContract.SyncFunProxy<Unit, (kotlin.collections.List<kotlin.Array<kotlin.Int>?>) ->
        kotlin.Unit> by lazy(mode = LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_bossWithCollectionsList", spyOn = if (spyOn
            != null) { { payload ->
    ...
    public val _bossWithVoid:
        ...
        kotlin.collections.List<kotlin.Array<kotlin.Int>?>> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_bossWithVoid", spyOn = if (spyOn != null) {
    ...
    public val _buzzWithT:
        KMockContract.SyncFunProxy<Unit, (kotlin.collections.List<kotlin.Array<kotlin.Int>>?) ->
        kotlin.Unit> by lazy(mode = LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_buzzWithT", spyOn = if (spyOn != null) { {
                payload ->
    ...
    public val _buzzWithVoid:
        ...
        kotlin.collections.List<kotlin.Array<kotlin.Int>>?> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_buzzWithVoid", spyOn = if (spyOn != null) {
            { buzz() } } else { null }, collector = verifier, freeze = freeze, relaxer = null)
    }

    public val _ozzWithL: KMockContract.SyncFunProxy<Unit, (L) -> kotlin.Unit> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_ozzWithL", spyOn = if (spyOn != null) { {
                payload ->
    ...
    public val _ozzWithVoid: KMockContract.SyncFunProxy<L, () -> L> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_ozzWithVoid", spyOn = if (spyOn != null) {
            { ozz() } } else { null }, collector = verifier, freeze = freeze, relaxer = null)
    }
    ...
    public val _brassWithComparable:
        ...
        kotlin.Unit> by lazy(mode = LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_brassWithComparable", spyOn = if (spyOn !=
            null) { { payload ->
    ...
    public val _brassWithVoid:
        ...
        kotlin.Comparable<kotlin.collections.List<kotlin.Array<kotlin.Any>>>> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_brassWithVoid", spyOn = if (spyOn != null)
        { { throw IllegalArgumentException(
            "Recursive generics are not supported on function level spies (yet)."
    ...
    public val _blissWithComparable:
        KMockContract.SyncFunProxy<Unit, (kotlin.Comparable<kotlin.collections.List<kotlin.Array<kotlin.Any?>>>?) ->
        kotlin.Unit> by lazy(mode = LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_blissWithComparable", spyOn = if (spyOn !=
            null) { { payload ->
            throw IllegalArgumentException(
                "Recursive generics are not supported on function level spies (yet)."
            ) } } else { null }, collector = verifier, freeze = freeze, unitFunRelaxer = if (relaxUnitFun)
    ...
    public val _blissWithVoid:
        ...
        kotlin.Comparable<kotlin.collections.List<kotlin.Array<kotlin.Any?>>>?> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_blissWithVoid", spyOn = if (spyOn != null)
        { { throw IllegalArgumentException(
            "Recursive generics are not supported on function level spies (yet)."
        ) } } else { null }, collector = verifier, freeze = freeze, relaxer = null)
    }
    ...
    public val _lossWithCollectionsMap:
        ...
        kotlin.Unit> by lazy(mode = LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_lossWithCollectionsMap", spyOn = if (spyOn
            != null) { { payload ->
    ...
    public val _lossWithVoid: KMockContract.SyncFunProxy<kotlin.collections.Map<kotlin.String,
        kotlin.String>, () -> kotlin.collections.Map<kotlin.String, kotlin.String>> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_lossWithVoid", spyOn = if (spyOn != null) {
            { loss() } } else { null }, collector = verifier, freeze = freeze, relaxer = null)
    }

    public val _uzzWithMockTemplateGenericSomeGeneric:
        KMockContract.SyncFunProxy<Unit, (kotlin.Any) -> kotlin.Unit> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_uzzWithMockTemplateGenericSomeGeneric",
    ...
    public val _uzzWithVoid: KMockContract.SyncFunProxy<Any, () -> kotlin.Any> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_uzzWithVoid", spyOn = if (spyOn != null) {
            { uzz() } } else { null }, collector = verifier, freeze = freeze, relaxer = null)
    }

    public val _lzzWithMockTemplateGenericSomeGeneric:
        KMockContract.SyncFunProxy<Unit, (kotlin.Any) -> kotlin.Unit> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_lzzWithMockTemplateGenericSomeGeneric",
            spyOn = if (spyOn != null) { { payload ->
                @Suppress("UNCHECKED_CAST")
                payload as mock.template.generic.SomeGeneric<kotlin.String>
                @Suppress("UNCHECKED_CAST")
    ...
    public val _lzzWithVoid: KMockContract.SyncFunProxy<Any, () -> kotlin.Any> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_lzzWithVoid", spyOn = if (spyOn != null) {
            { lzz() } } else { null }, collector = verifier, freeze = freeze, relaxer = null)
    }

    public val _tzzWithMockTemplateGenericSomeGeneric:
        KMockContract.SyncFunProxy<Unit, (kotlin.Any?) -> kotlin.Unit> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_tzzWithMockTemplateGenericSomeGeneric",
            spyOn = if (spyOn != null) { { payload ->
                @Suppress("UNCHECKED_CAST")
                payload as mock.template.generic.SomeGeneric<kotlin.String>?
                @Suppress("UNCHECKED_CAST")
    ...
    public val _tzzWithVoid: KMockContract.SyncFunProxy<Any?, () -> kotlin.Any?> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_tzzWithVoid", spyOn = if (spyOn != null) {
            { tzz() } } else { null }, collector = verifier, freeze = freeze, relaxer = null)
    }

    public val _rzzWithMockTemplateGenericSomeGeneric:
        KMockContract.SyncFunProxy<Unit, (kotlin.Any) -> kotlin.Unit> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_rzzWithMockTemplateGenericSomeGeneric",
            spyOn = if (spyOn != null) { { payload ->
                @Suppress("UNCHECKED_CAST")
                payload as mock.template.generic.SomeGeneric<kotlin.String>
                @Suppress("UNCHECKED_CAST")
    ...
    public val _rzzWithVoid: KMockContract.SyncFunProxy<Any, () -> kotlin.Any> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_rzzWithVoid", spyOn = if (spyOn != null) {
            { rzz() } } else { null }, collector = verifier, freeze = freeze, relaxer = null)
    }

    public val _izzWithMockTemplateGenericSomeGeneric:
        KMockContract.SyncFunProxy<Unit, (kotlin.Any) -> kotlin.Unit> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_izzWithMockTemplateGenericSomeGeneric",
            spyOn = if (spyOn != null) { { payload ->
                throw IllegalArgumentException(
                    "Recursive generics are not supported on function level spies (yet)."
                ) } } else { null }, collector = verifier, freeze = freeze, unitFunRelaxer = if (relaxUnitFun)
    ...
    public val _izzWithVoid: KMockContract.SyncFunProxy<Any, () -> kotlin.Any> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_izzWithVoid", spyOn = if (spyOn != null) {
            { throw IllegalArgumentException(
                "Recursive generics are not supported on function level spies (yet)."
            ) } } else { null }, collector = verifier, freeze = freeze, relaxer = null)
    }
    ...
    kotlin.Unit> by lazy(mode = LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_ossWithAnyAny", spyOn = if (spyOn != null)
        { { arg0, arg1 ->
    ...
    public val _ossWithAny: KMockContract.SyncFunProxy<Any?, (kotlin.Any?) -> kotlin.Any?> by
    lazy(mode = LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_ossWithAny", spyOn = if (spyOn != null) { {
                arg0 ->
    ...
    public val _kssWithMockTemplateGenericSomeGenericMockTemplateGenericSomeGeneric:
        KMockContract.SyncFunProxy<Unit, (kotlin.Any, kotlin.Any) -> kotlin.Unit> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {

        SyncFunProxy("mock.template.generic.SharedMock#_kssWithMockTemplateGenericSomeGenericMockTemplateGenericSomeGeneric",
    ...
    kotlin.Any> by lazy(mode = LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_kssWithMockTemplateGenericSomeGeneric",
    ...
    public val _issWithAnyMockTemplateGenericSomeGeneric:
        KMockContract.SyncFunProxy<Unit, (kotlin.Any?, kotlin.Any) -> kotlin.Unit> by lazy(mode =
    LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_issWithAnyMockTemplateGenericSomeGeneric",
            spyOn = if (spyOn != null) { { arg0, arg1 ->
                @Suppress("UNCHECKED_CAST")
    ...
    public val _issWithAny: KMockContract.SyncFunProxy<Any, (kotlin.Any?) -> kotlin.Any> by lazy(mode
    = LazyThreadSafetyMode.PUBLICATION) {
        SyncFunProxy("mock.template.generic.SharedMock#_issWithAny", spyOn = if (spyOn != null) { {
                arg0 ->
