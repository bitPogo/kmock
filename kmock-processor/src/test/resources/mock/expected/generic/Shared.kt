...
internal class SharedMock<K : Any, L>(
    ...
    public val _template: KMockContract.PropertyProxy<L> = if (spyOn == null) {
        PropertyProxy("mock.template.generic.Shared#_template", spyOnGet = null, spyOnSet = null,
            collector = verifier, freeze = freeze, relaxer = null)
    } else {
        PropertyProxy("mock.template.generic.Shared#_template", spyOnGet = { spyOn.template },
    ...
    public val _fooWithVoid: KMockContract.SyncFunProxy<Any?, () -> kotlin.Any?> =
        SyncFunProxy("mock.template.generic.Shared#_fooWithVoid", spyOn = if (spyOn != null) { { foo()
    ...
    public val _fooWithAny: KMockContract.SyncFunProxy<Unit, (kotlin.Any?) -> kotlin.Unit> =
        SyncFunProxy("mock.template.generic.Shared#_fooWithAny", spyOn = if (spyOn != null) { {
                payload ->
    ...
    public val _blaWithVoid: KMockContract.SyncFunProxy<Int, () -> kotlin.Int> =
        SyncFunProxy("mock.template.generic.Shared#_blaWithVoid", spyOn = if (spyOn != null) { { bla()
        } } else { null }, collector = verifier, freeze = freeze, relaxer = null)

    public val _blaWithInt: KMockContract.SyncFunProxy<Unit, (kotlin.Int) -> kotlin.Unit> =
        SyncFunProxy("mock.template.generic.Shared#_blaWithInt", spyOn = if (spyOn != null) { {
                payload ->
    ...
    public val _barWithCollectionsList:
        ...
        kotlin.Unit> = SyncFunProxy("mock.template.generic.Shared#_barWithCollectionsList", spyOn = if
                                                                                                        (spyOn != null) { { payload ->
    ...
    public val _barWithVoid:
        ...
        SyncFunProxy("mock.template.generic.Shared#_barWithVoid", spyOn = if (spyOn != null) { { bar()
        } } else { null }, collector = verifier, freeze = freeze, relaxer = null)

    public val _blubbWithCollectionsList:
        KMockContract.SyncFunProxy<Unit, (kotlin.collections.List<kotlin.Array<kotlin.String?>>) ->
        kotlin.Unit> = SyncFunProxy("mock.template.generic.Shared#_blubbWithCollectionsList", spyOn =
    ...
    public val _blubbWithVoid:
        KMockContract.SyncFunProxy<kotlin.collections.List<kotlin.Array<kotlin.String?>>, () ->
        kotlin.collections.List<kotlin.Array<kotlin.String?>>> =
        SyncFunProxy("mock.template.generic.Shared#_blubbWithVoid", spyOn = if (spyOn != null) { {
    ...
    public val _bussWithCollectionsList:
        ...
        kotlin.Unit> = SyncFunProxy("mock.template.generic.Shared#_bussWithCollectionsList", spyOn =
    if (spyOn != null) { { payload ->
    ...
    public val _bussWithVoid:
        ...
        SyncFunProxy("mock.template.generic.Shared#_bussWithVoid", spyOn = if (spyOn != null) { {
            buss() } } else { null }, collector = verifier, freeze = freeze, relaxer = null)

    public val _bossWithCollectionsList:
        KMockContract.SyncFunProxy<Unit, (kotlin.collections.List<kotlin.Array<kotlin.Int>?>) ->
        kotlin.Unit> = SyncFunProxy("mock.template.generic.Shared#_bossWithCollectionsList", spyOn =
    if (spyOn != null) { { payload ->
    ...
    public val _bossWithVoid:
        KMockContract.SyncFunProxy<kotlin.collections.List<kotlin.Array<kotlin.Int>?>, () ->
        kotlin.collections.List<kotlin.Array<kotlin.Int>?>> =
        SyncFunProxy("mock.template.generic.Shared#_bossWithVoid", spyOn = if (spyOn != null) { {
            boss() } } else { null }, collector = verifier, freeze = freeze, relaxer = null)

    public val _buzzWithT:
        KMockContract.SyncFunProxy<Unit, (kotlin.collections.List<kotlin.Array<kotlin.Int>>?) ->
        kotlin.Unit> = SyncFunProxy("mock.template.generic.Shared#_buzzWithT", spyOn = if (spyOn !=
        null) { { payload ->
    ...
    public val _buzzWithVoid:
        KMockContract.SyncFunProxy<kotlin.collections.List<kotlin.Array<kotlin.Int>>?, () ->
        kotlin.collections.List<kotlin.Array<kotlin.Int>>?> =
        SyncFunProxy("mock.template.generic.Shared#_buzzWithVoid", spyOn = if (spyOn != null) { {
    ...
    public val _ozzWithL: KMockContract.SyncFunProxy<Unit, (L) -> kotlin.Unit> =
        SyncFunProxy("mock.template.generic.Shared#_ozzWithL", spyOn = if (spyOn != null) { {
                payload ->
    ...
    public val _ozzWithVoid: KMockContract.SyncFunProxy<L, () -> L> =
        SyncFunProxy("mock.template.generic.Shared#_ozzWithVoid", spyOn = if (spyOn != null) { { ozz()
        } } else { null }, collector = verifier, freeze = freeze, relaxer = null)
    ...
    public val _brassWithComparable:
        ...
        kotlin.Unit> = SyncFunProxy("mock.template.generic.Shared#_brassWithComparable", spyOn = if
                                                                                                     (spyOn != null) { { payload ->
    ...
    public val _brassWithVoid:
        ...
        SyncFunProxy("mock.template.generic.Shared#_brassWithVoid", spyOn = if (spyOn != null) { {
            throw IllegalArgumentException(
                "Recursive generics are not supported on function level spies (yet)."
            ) } } else { null }, collector = verifier, freeze = freeze, relaxer = null)
    ...
    public val _blissWithComparable:
        KMockContract.SyncFunProxy<Unit, (kotlin.Comparable<kotlin.collections.List<kotlin.Array<kotlin.Any?>>>?) ->
        kotlin.Unit> = SyncFunProxy("mock.template.generic.Shared#_blissWithComparable", spyOn = if
                                                                                                     (spyOn != null) { { payload ->
        throw IllegalArgumentException(
            "Recursive generics are not supported on function level spies (yet)."
        ) } } else { null }, collector = verifier, freeze = freeze, unitFunRelaxer = if (relaxUnitFun)
    ...
    public val _blissWithVoid:
        KMockContract.SyncFunProxy<kotlin.Comparable<kotlin.collections.List<kotlin.Array<kotlin.Any?>>>?, () ->
        kotlin.Comparable<kotlin.collections.List<kotlin.Array<kotlin.Any?>>>?> =
        SyncFunProxy("mock.template.generic.Shared#_blissWithVoid", spyOn = if (spyOn != null) { {
            throw IllegalArgumentException(
                "Recursive generics are not supported on function level spies (yet)."
            ) } } else { null }, collector = verifier, freeze = freeze, relaxer = null)
    ...
    public val _lossWithCollectionsMap:
        ...
        kotlin.Unit> = SyncFunProxy("mock.template.generic.Shared#_lossWithCollectionsMap", spyOn = if
                                                                                                        (spyOn != null) { { payload ->
    ...
    public val _lossWithVoid: KMockContract.SyncFunProxy<kotlin.collections.Map<kotlin.String,
        ...
        SyncFunProxy("mock.template.generic.Shared#_lossWithVoid", spyOn = if (spyOn != null) { {
    ...
    public val _uzzWithMockTemplateGenericSomeGeneric:
        ...
        SyncFunProxy("mock.template.generic.Shared#_uzzWithMockTemplateGenericSomeGeneric", spyOn = if
                                                                                                        (spyOn != null) { { payload ->
    ...
    public val _uzzWithVoid: KMockContract.SyncFunProxy<Any, () -> kotlin.Any> =
        SyncFunProxy("mock.template.generic.Shared#_uzzWithVoid", spyOn = if (spyOn != null) { { uzz()
        } } else { null }, collector = verifier, freeze = freeze, relaxer = null)

    public val _lzzWithMockTemplateGenericSomeGeneric:
        KMockContract.SyncFunProxy<Unit, (kotlin.Any) -> kotlin.Unit> =
        SyncFunProxy("mock.template.generic.Shared#_lzzWithMockTemplateGenericSomeGeneric", spyOn = if
                                                                                                        (spyOn != null) { { payload ->
            @Suppress("UNCHECKED_CAST")
            payload as mock.template.generic.SomeGeneric<kotlin.String>
            @Suppress("UNCHECKED_CAST")
    ...
    public val _lzzWithVoid: KMockContract.SyncFunProxy<Any, () -> kotlin.Any> =
        SyncFunProxy("mock.template.generic.Shared#_lzzWithVoid", spyOn = if (spyOn != null) { { lzz()
        } } else { null }, collector = verifier, freeze = freeze, relaxer = null)

    public val _tzzWithMockTemplateGenericSomeGeneric:
        KMockContract.SyncFunProxy<Unit, (kotlin.Any?) -> kotlin.Unit> =
        SyncFunProxy("mock.template.generic.Shared#_tzzWithMockTemplateGenericSomeGeneric", spyOn = if
                                                                                                        (spyOn != null) { { payload ->
            @Suppress("UNCHECKED_CAST")
            payload as mock.template.generic.SomeGeneric<kotlin.String>?
            @Suppress("UNCHECKED_CAST")
    ...
    public val _tzzWithVoid: KMockContract.SyncFunProxy<Any?, () -> kotlin.Any?> =
        SyncFunProxy("mock.template.generic.Shared#_tzzWithVoid", spyOn = if (spyOn != null) { { tzz()
        } } else { null }, collector = verifier, freeze = freeze, relaxer = null)

    public val _rzzWithMockTemplateGenericSomeGeneric:
        KMockContract.SyncFunProxy<Unit, (kotlin.Any) -> kotlin.Unit> =
        SyncFunProxy("mock.template.generic.Shared#_rzzWithMockTemplateGenericSomeGeneric", spyOn = if
                                                                                                        (spyOn != null) { { payload ->
            @Suppress("UNCHECKED_CAST")
            payload as mock.template.generic.SomeGeneric<kotlin.String>
            @Suppress("UNCHECKED_CAST")
    ...
    public val _rzzWithVoid: KMockContract.SyncFunProxy<Any, () -> kotlin.Any> =
        SyncFunProxy("mock.template.generic.Shared#_rzzWithVoid", spyOn = if (spyOn != null) { { rzz()
        } } else { null }, collector = verifier, freeze = freeze, relaxer = null)

    public val _izzWithMockTemplateGenericSomeGeneric:
        KMockContract.SyncFunProxy<Unit, (kotlin.Any) -> kotlin.Unit> =
        SyncFunProxy("mock.template.generic.Shared#_izzWithMockTemplateGenericSomeGeneric", spyOn = if
                                                                                                        (spyOn != null) { { payload ->
            throw IllegalArgumentException(
                "Recursive generics are not supported on function level spies (yet)."
            ) } } else { null }, collector = verifier, freeze = freeze, unitFunRelaxer = if (relaxUnitFun)
    ...
    public val _izzWithVoid: KMockContract.SyncFunProxy<Any, () -> kotlin.Any> =
        SyncFunProxy("mock.template.generic.Shared#_izzWithVoid", spyOn = if (spyOn != null) { { throw
        IllegalArgumentException(
            "Recursive generics are not supported on function level spies (yet)."
        ) } } else { null }, collector = verifier, freeze = freeze, relaxer = null)

    public val _ossWithAnyAny: KMockContract.SyncFunProxy<Unit, (kotlin.Any?, kotlin.Any?) ->
    kotlin.Unit> = SyncFunProxy("mock.template.generic.Shared#_ossWithAnyAny", spyOn = if (spyOn
        != null) { { arg0, arg1 ->
    ...
    public val _ossWithAny: KMockContract.SyncFunProxy<Any?, (kotlin.Any?) -> kotlin.Any?> =
        SyncFunProxy("mock.template.generic.Shared#_ossWithAny", spyOn = if (spyOn != null) { {
                arg0 ->
    ...
    public val _kssWithMockTemplateGenericSomeGenericMockTemplateGenericSomeGeneric:
        ...
        SyncFunProxy("mock.template.generic.Shared#_kssWithMockTemplateGenericSomeGenericMockTemplateGenericSomeGeneric",
    ...
    kotlin.Any> =
        SyncFunProxy("mock.template.generic.Shared#_kssWithMockTemplateGenericSomeGeneric", spyOn = if
                                                                                                        (spyOn != null) { { arg0 ->
            throw IllegalArgumentException(
                "Recursive generics are not supported on function level spies (yet)."
            ) } } else { null }, collector = verifier, freeze = freeze, relaxer = null)
    ...
    public val _issWithAnyMockTemplateGenericSomeGeneric:
        KMockContract.SyncFunProxy<Unit, (kotlin.Any?, kotlin.Any) -> kotlin.Unit> =
        SyncFunProxy("mock.template.generic.Shared#_issWithAnyMockTemplateGenericSomeGeneric", spyOn =
    ...
    public val _issWithAny: KMockContract.SyncFunProxy<Any, (kotlin.Any?) -> kotlin.Any> =
        SyncFunProxy("mock.template.generic.Shared#_issWithAny", spyOn = if (spyOn != null) { {
                arg0 ->
            iss(arg0) } } else { null }, collector = verifier, freeze = freeze, relaxer = null)

    public val _toString: KMockContract.SyncFunProxy<String, () -> kotlin.String> =
        SyncFunProxy("mock.template.generic.Shared#_toString", spyOn = if (spyOn != null) { {
    ...
    public val _equals: KMockContract.SyncFunProxy<Boolean, (kotlin.Any?) -> kotlin.Boolean> =
        SyncFunProxy("mock.template.generic.Shared#_equals", spyOn = if (spyOn != null) { { other ->
    ...
    public val _hashCode: KMockContract.SyncFunProxy<Int, () -> kotlin.Int> =
        SyncFunProxy("mock.template.generic.Shared#_hashCode", spyOn = if (spyOn != null) { {
