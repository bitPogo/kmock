...
internal class CommonMock<K : Any, L>(
    ...
    public val _toString: KMockContract.SyncFunProxy<String, () -> kotlin.String> =
        SyncFunProxy("mock.template.generic.Common#_toString", spyOn = if (spyOn != null) { {
    ...
    public val _equals: KMockContract.SyncFunProxy<Boolean, (kotlin.Any?) -> kotlin.Boolean> =
        SyncFunProxy("mock.template.generic.Common#_equals", spyOn = if (spyOn != null) { { other ->
    ...
    public val _hashCode: KMockContract.SyncFunProxy<Int, () -> kotlin.Int> =
        SyncFunProxy("mock.template.generic.Common#_hashCode", spyOn = if (spyOn != null) { {
